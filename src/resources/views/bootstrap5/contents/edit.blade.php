                ...
                <div class="card">
                        ...
                        <table class="table table-sm table-hover">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $content->displayed ? __('lara-cms-lite::content.yes') : __('lara-cms-lite::content.no') }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>{{ __('lara-cms-lite::content.display_title') }}</td>
                                    <td>{{ $content->display_title ? __('lara-cms-lite::content.yes') : __('lara-cms-lite::content.no') }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>{{ __('lara-cms-lite::content.display_footer') }}</td>
                                    <td>{{ $content->display_footer ? __('lara-cms-lite::content.yes') : __('lara-cms-lite::content.no') }}
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="card-footer">
                        <form method="POST" action="{{ route('contents.destroy', $content) }}" accept-charset="UTF-8"
                            onsubmit="return confirm(&quot;{{ __('lara-cms-lite::content.delete_confirm') }}&quot;)"
                            class="del-form float-end" style="display: inline;">
                            {{ csrf_field() }} {{ method_field('delete') }}
                            <input name="content_id" type="hidden" value="{{ $content->id }}">
                            <button type="submit"
                                class="btn btn-danger">{{ __('lara-cms-lite::content.delete') }}</button>
                        </form>
                        <a href="{{ route('contents.edit', $content) }}"
                            class="btn btn-link">{{ __('lara-cms-lite::content.cancel') }}</a>
                    </div>
                </div>
            @else
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('contents.update', $content) }}" accept-charset="UTF-8">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <label for="redactor"
                                    class="col-sm-4 col-form-label">{{ __('lara-cms-lite::content.creator') }}</label>
                                <div class="col-sm-8">
                                    <input disabled id="redactor" type="text"
                                        class="form-control{{ $errors->has('redactor') ? ' is-invalid' : '' }}"
                                        name="redactor" value="{{ old('redactor', $content->user->username) }}">
                                    {!! $errors->first(
                                        'redactor',
                            ...
                            <div class="row mb-3">
                                <label for="displayed"
                                    class="col-sm-4 col-form-label">{{ __('lara-cms-lite::content.displayed') }}</label>
                                <div class="col-sm-8">
                                    <select id="displayed" name="displayed" class="form-select" required>
                                        <option value="1" {{ $content->displayed ? 'selected' : '' }}>
                                            {{ __('lara-cms-lite::content.yes') }}</option>
                                        <option value="0" {{ $content->displayed == 0 ? 'selected' : '' }}>
                            ...
                            <div class="row mb-3">
                                <label for="display_title"
                                    class="col-sm-4 col-form-label">{{ __('lara-cms-lite::content.display_title') }}</label>
                                <div class="col-sm-8">
                                    <select id="display_title" name="display_title" class="form-select" required>
                                        <option value="1" {{ $content->display_title ? 'selected' : '' }}>
                                            {{ __('lara-cms-lite::content.yes') }}
                                        </option>
                                        <option value="0" {{ $content->display_title == 0 ? 'selected' : '' }}>
                                            {{ __('lara-cms-lite::content.no') }}
                                        </option>
                                    </select>
                                    {!! $errors->first(
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-8">
                                    <select id="display_footer" name="display_footer" class="form-select" required>
                                        <option value="1" {{ $content->display_footer ? 'selected' : '' }}>
                                            {{ __('lara-cms-lite::content.yes') }}
                                        </option>
                            ...
                            <div class="row mb-3">
                                <label for="created_at"
                                    class="col-sm-4 col-form-label">{{ __('lara-cms-lite::content.created_at') }}</label>
                                <div class="col-sm-8">
                            ...
                            <div class="row mb-3">
                                <label for="updated_at"
                                    class="col-sm-4 col-form-label">{{ __('lara-cms-lite::content.updated_at') }}</label>
                                <div class="col-sm-8">
                            ...
                            <div class="row mb-3">
                                <label for="weight"
                                    class="col-sm-4 col-form-label">{{ __('lara-cms-lite::content.weight') }} </label>
                                <div class="col-sm-8">
                                    <input id="weight" type="integer"
                                        class="form-control{{ $errors->has('weight') ? ' is-invalid' : '' }}"
                                        name="weight" value="{{ old('weight', $content->weight) }}">
                                    ...
                                    @foreach ($routes as $route)
                                        @if ($route->getname())
                                            <option value="{{ $route->getname() }}"
                                                {{ $route->getname() == $content->route ? 'selected' : '' }}>
                                                {{ $route->uri() }}
                                            </option>
                                        @endif
                                    @endforeach
                            ...
                            <div class="mb-3">
                                <label for="description"
                                    class="form-label"><b>{{ __('lara-cms-lite::content.description') }}</b></label>
                        ...
                        <div class="card-footer">
                            <input type="submit" value="{{ __('lara-cms-lite::content.update') }}"
                                class="btn btn-success">
                            <a href="{{ route('contents.show', $content) }}"
                                class="btn btn-link">{{ __('lara-cms-lite::content.cancel') }}</a>

                            <a href="{{ route('contents.edit', [$content, 'action' => 'delete']) }}"
                                id="del-content-{{ $content->id }}"
                                class="btn btn-danger float-end">{{ __('lara-cms-lite::content.delete') }}</a>
                        </div>
                    </form>
                </div>
        </div>
...
@section('scripts')
    <script src="{{ config('lara-cms-lite.tinymce_url') }}"></script>
