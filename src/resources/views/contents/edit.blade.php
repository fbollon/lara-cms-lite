                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            {!! $errors->first('display_title', '<span class="invalid-feedback"
                                role="alert">:message</span>') !!}
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            {!! $errors->first('display_footer', '<span class="invalid-feedback"
                                role="alert">:message</span>') !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input id="weight" type="integer"
                                ...
                                value="{{ old('weight', $content->weight) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}"
                            name="name" value="{{ old('name', $content->name) }}" required>
